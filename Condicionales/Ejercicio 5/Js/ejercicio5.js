...
const edadesPersonasExp = function(paAño1,paAño2,paAño3){
    ...
    let promedio
    let aviso
    document.writeln(edad1 + calcularMayoriaDeEdad(paAño1) + "<br>")
    document.writeln(edad2 + calcularMayoriaDeEdad(paAño2) + "<br>")
    document.writeln(edad3 + calcularMayoriaDeEdad(paAño3) + "<br>")

    promedio= (calcularMayoriaDeEdadExp(paAño1)+calcularMayoriaDeEdadExp(paAño2)+edad3  + calcularMayoriaDeEdadExp(paAño3))/3

    if(promedio>17){
        aviso = "El promedio de las edades si cumple la mayoria de edad "
        document.writeln(aviso)
     
    }else{
        aviso = "El promedio de las edades no cumple la mayoria de edad "
        document.writeln(aviso)
